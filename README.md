...
/plugin install nemo-caveman          # /terse: respuestas ultra-compactas
...
| **nemo-caveman** | Command | `/terse` activa modo respuestas ultra-compactas (drop fluff, keep technical substance). Adaptado de `mattpocock/skills` (MIT) |
